...
export default {
  rentalCompany: {
    ...
    contact: {
      ...
      email: "support@GondarCarRentals.com",
      address: "89 Churchill Ave., Addis Ababa, Ethiopia",
    },
    branches: [
      {
        branchId: "GON-001",
        city: "Gondar",
        address: "12 Kazanchis St., Gondar",
        phone: "+251-58-123-4567",
        openingHours: "8:00 AM - 8:00 PM",
        map: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31149.615698551654!2d37.43513236689505!3d12.60188351130028!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x16432903deb758ed%3A0x69a1df405bb22ef2!2sAutomotive%20service!5e0!3m2!1sen!2set!4v1749694924268!5m2!1sen!2set",
      },
      {
        branchId: "BAH-002",
        city: "Bahrdar",
        address: "45 Blue Nile Rd., Bahrdar",
        phone: "+251-58-765-4321",
        openingHours: "7:00 AM - 9:00 PM",
        map: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11760.168378070357!2d37.39821344781037!3d11.596307786744811!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1644cf70f0966745%3A0xd11c9ac1d1f1b092!2sBahirdar%20Car%20Rental!5e0!3m2!1sen!2set!4v1749696394465!5m2!1sen!2set",
      },
      {
        branchId: "ADD-003",
        city: "Addis Ababa",
        address: "89 Churchill Ave., Addis Ababa",
        phone: "+251-11-234-5678",
        openingHours: "9:00 AM - 7:00 PM",
        map: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11369.715281467168!2d38.7169569082821!3d8.965887262424284!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x164b86ac5b1a40f3%3A0x9654fdc325137c1a!2sSuzuki%20Automotive%20Service%20plc!5e0!3m2!1sen!2set!4v1749696453320!5m2!1sen!2set",
      },
    ],
  },
  cars: [
    {
      ...
      availability: true,
      description:
        "Comfortable and fuel-efficient sedan ideal for city driving and business trips. Reliable with advanced features for a smooth ride.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "32 MPG city / 42 MPG highway",
        color: "White",
      },
      horsePower: 203,
      location: {
        city: "Gondar",
        address: "200 Meskel St., Gondar",
      },
      rentalPolicies: {
        minRentalDays: 2,
      ...
      customerReviews: [
        {
          reviewer: "Jane D.",
          rating: 5,
          comment: "Smooth ride and clean car. Perfect for my business trip.",
        },
        {
          reviewer: "Mark S.",
          rating: 4,
          comment: "Reliable car but GPS navigation was a little outdated.",
        },
      ],
      photos: [
        ToyotaCamryPhoto0,
    ...
    },
    {
      ...
      year: 2021,
      category: "SUV",
      rentalPricePerDay: 1950,
      availability: true,
      description:
        "A versatile and eco-friendly hybrid SUV offering ample space and advanced tech, perfect for family adventures or weekend escapes.",
      features: {
        transmission: "Auto",
        fuelType: "Hybrid",
        seats: 5,
        ...
        bluetooth: true,
        sunroof: true,
        fuelEfficiency: "41 MPG combined",
        color: "Silver",
      },
      horsePower: 219,
      location: {
        city: "Bahrdar",
        address: "12 Kuriftu Rd., Bahrdar",
      },
      rentalPolicies: {
        minRentalDays: 3,
      ...
      customerReviews: [
        {
          reviewer: "Lily R.",
          rating: 5,
          comment: "Perfect for my family trips and great on gas.",
        },
        {
          reviewer: "Tom P.",
          rating: 4,
          comment: "Comfortable with all the modern features.",
        },
      ],
      photos: [
        ToyotaRAV4Photo0,
    ...
    },
    {
      ...
      year: 2020,
      category: "Sedan",
      rentalPricePerDay: 1350,
      availability: true,
      description:
        "Economical and easy to drive sedan, perfect for daily commutes and budget-friendly travel without sacrificing comfort.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
      ...
      location: {
        city: "Addis Ababa",
        address: "45 Bole Rd., Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 1,
        mileageUnlimited: false,
        ...
        insuranceIncluded: false,
        insuranceOptions: ["Basic Coverage", "Full Coverage"],
      ...
      customerReviews: [
        {
          reviewer: "Kevin W.",
          rating: 4,
          comment: "Affordable and easy to drive, but GPS was missing.",
        },
        {
          reviewer: "Emily F.",
          rating: 3,
          comment: "Great fuel saver and comfortable ride.",
        },
      ],
      photos: [
        ToyotaCorollaPhoto0,
    ...
    },
    {
      ...
      availability: false,
      description:
        "Efficient hybrid SUV ideal for eco-conscious travelers who need space and comfort for their trips.",
      features: {
        transmission: "Auto",
        fuelType: "Hybrid",
        seats: 5,
        ...
        bluetooth: true,
        sunroof: true,
        fuelEfficiency: "44 MPG combined",
        color: "Metallic Gray",
      },
      horsePower: 200,
      location: {
        city: "Gondar",
        address: "78 Sesame St., Gondar",
      },
      rentalPolicies: {
        minRentalDays: 3,
        mileageUnlimited: true,
      ...
      customerReviews: [
        {
          reviewer: "Lily R.",
          rating: 5,
          comment: "Love the hybrid. Saved me a lot on gas.",
        },
        {
          reviewer: "Tom P.",
          rating: 3,
          comment: "Comfortable but had a minor issue with trunk sensor.",
        },
      ],
      photos: [
        FordEscapePhoto0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Classic American muscle car providing thrilling performance and style for drivers who want to make an impression.",
      features: {
        transmission: "Manual",
        fuelType: "Gasoline",
        seats: 4,
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "21 MPG city / 30 MPG highway",
        color: "Red",
      },
      horsePower: 310,
      location: {
        city: "Bahrdar",
        address: "23 Meles Zenawi Blvd., Bahrdar",
      },
      rentalPolicies: {
        minRentalDays: 1,
        mileageUnlimited: false,
      ...
      customerReviews: [
        {
          reviewer: "Steve B.",
          rating: 5,
          comment: "Powerful and fun car to drive.",
        },
        {
          reviewer: "Nina C.",
          rating: 4,
          comment: "Great for weekend getaways.",
        },
      ],
      photos: [
        FordMustangPhoto0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Robust and reliable pickup truck capable of handling heavy loads and off-road terrain with ease.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
        ...
        gps: true,
        bluetooth: false,
        fuelEfficiency: "20 MPG city / 26 MPG highway",
        color: "Blue",
      },
      horsePower: 290,
      location: {
        city: "Addis Ababa",
        address: "110 Sar Bet St., Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: true,
        insuranceIncluded: true,
        depositRequired: 10500,
      },
      customerReviews: [
        {
          reviewer: "Rachel G.",
          rating: 4,
          comment: "Great truck for heavy duty transport.",
        },
        {
          reviewer: "Peter N.",
          rating: 5,
          comment: "Reliable and powerful.",
        },
      ],
      photos: [
        FordF150Photo0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Experience cutting-edge electric driving with excellent range and luxury interiors. Perfect for environmentally-conscious travelers.",
      features: {
        transmission: "Auto",
        fuelType: "Electric",
        seats: 5,
      ...
      location: {
        city: "Gondar",
        address: "35 Arbegnoch St., Gondar",
      },
      rentalPolicies: {
        minRentalDays: 1,
        mileageUnlimited: true,
      ...
      customerReviews: [
        {
          ...
          rating: 5,
          comment:
            "Fantastic electric car experience. The autopilot feature is outstanding.",
        },
        {
          reviewer: "Sara M.",
          rating: 4,
          comment:
            "Smooth ride but charging stations were hard to find in some areas.",
        },
      ],
      photos: [
        TeslaModel3Photo0,
    ...
    },
    {
      ...
      year: 2022,
      category: "Electric",
      rentalPricePerDay: 5400,
      availability: true,
      description:
        "Luxury electric sedan boasting long range and top performance. Enjoy premium comfort and cutting-edge technology.",
      features: {
        transmission: "Auto",
        fuelType: "Electric",
        seats: 5,
      ...
      customerReviews: [
        {
          reviewer: "Jordan P.",
          rating: 5,
          comment: "Best electric car I've ever driven.",
        },
        {
          reviewer: "Megan S.",
          rating: 5,
    ...
    },
    {
      ...
      availability: false,
      description:
        "Spacious electric SUV with seating for seven, cutting edge tech, and impressive electric range. Perfect for family travels in style.",
      features: {
        transmission: "Auto",
        fuelType: "Electric",
        seats: 7,
      ...
      location: {
        city: "Addis Ababa",
        address: "150 Ethiopia Ave., Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: true,
      ...
      customerReviews: [
        {
          reviewer: "Gloria V.",
          rating: 5,
          comment: "Spacious and very comfortable for family trips.",
        },
        {
          reviewer: "Henry M.",
          rating: 4,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Luxury SUV offering top-notch comfort, heated leather seats, and powerful performance for premium travel experiences.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
        ...
        fuelEfficiency: "21 MPG city / 25 MPG highway",
        color: "Black",
      },
      horsePower: 335,
      location: {
        city: "Gondar",
        address: "18 Fasil St., Gondar",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: false,
      ...
      customerReviews: [
        {
          reviewer: "George L.",
          rating: 5,
          comment: "Luxury and comfort combined. Perfect for long drives.",
        },
        {
          reviewer: "Anna T.",
          rating: 4,
          comment: "Well maintained vehicle but a bit pricey.",
        },
      ],
      photos: [
        BMWX5Photo0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Elegant and sporty sedan offering excellent handling, heated leather seats, and advanced safety features.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
      ...
      location: {
        city: "Bahrdar",
        address: "9 Sun River Rd., Bahrdar",
      },
      rentalPolicies: {
        minRentalDays: 1,
        mileageUnlimited: false,
        ...
        insuranceIncluded: true,
        depositRequired: 11400,
      },
      customerReviews: [
        {
          reviewer: "Rachel M.",
          rating: 5,
          comment: "Smooth ride with great handling.",
        },
        {
          reviewer: "Jason F.",
          rating: 4,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Diesel-powered SUV delivering strong performance, luxury amenities, and excellent fuel economy perfect for city or highway travel.",
      features: {
        transmission: "Auto",
        fuelType: "Diesel",
        seats: 5,
        ...
        heatedSeats: true,
        leatherInterior: true,
        fuelEfficiency: "25 MPG city / 29 MPG highway",
        color: "White",
      },
      horsePower: 248,
      location: {
        city: "Addis Ababa",
        address: "215 Africa Ave., Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: false,
      ...
      customerReviews: [
        ...
        },
        {
          reviewer: "Daniel T.",
          rating: 4,
          comment: "Great SUV for city and highway driving.",
        },
      ],
      photos: [
        BMWX3Photo0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Reliable and economical manual sedan, perfect for budget travelers and city commuters seeking fuel efficiency.",
      features: {
        transmission: "Manual",
        fuelType: "Gasoline",
        seats: 5,
      ...
      customerReviews: [
        {
          reviewer: "Kevin W.",
          rating: 4,
          comment: "Affordable and easy to drive, but lacks GPS.",
        },
        {
          reviewer: "Emily F.",
          rating: 3,
          comment: "Manual transmission was a challenge for me.",
        },
      ],
      photos: [
        HondaCivicPhoto0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Spacious and fuel-efficient hybrid sedan, excellent for comfortable commuting and long road trips.",
      features: {
        transmission: "Auto",
        fuelType: "Hybrid",
        seats: 5,
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "48 MPG city / 47 MPG highway",
        color: "Silver",
      },
      horsePower: 212,
      location: {
        city: "Bahrdar",
        address: "80 Abbay Avenue, Bahrdar",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: true,
      ...
      customerReviews: [
        {
          reviewer: "Anna K.",
          rating: 5,
          comment: "Very comfortable and fuel efficient car.",
        },
        {
          reviewer: "Mike H.",
          rating: 4,
          comment: "Smooth driving experience.",
        },
      ],
      photos: [
        HondaAccordPhoto0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Spacious and reliable SUV with great fuel economy, perfect for family trips and urban driving.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "28 MPG city / 34 MPG highway",
        color: "Black",
      },
      horsePower: 190,
      location: {
        city: "Addis Ababa",
        address: "15 Churchill St., Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 3,
        mileageUnlimited: true,
      ...
      customerReviews: [
        {
          reviewer: "Samantha R.",
          rating: 5,
          comment: "Great SUV for city and road trips.",
        },
        {
          reviewer: "David P.",
          rating: 4,
          comment: "Fuel efficient and spacious.",
        },
      ],
      photos: [
        HondaCRVPhoto0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Comfortable sedan with smooth ride and spacious interior, ideal for both business and leisure travel.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
      ...
      customerReviews: [
        {
          reviewer: "Rachel G.",
          rating: 4,
          comment: "Good car for family trips, comfortable seats.",
        },
        {
          reviewer: "Peter N.",
          rating: 5,
          comment: "Smooth driving experience and good fuel economy.",
        },
      ],
      photos: [
    ...
    },
    {
      ...
      availability: true,
      description:
        "Reliable and fuel-efficient SUV with plenty of space, suitable for family travel and outdoor adventures.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "26 MPG city / 31 MPG highway",
        color: "Blue",
      },
      horsePower: 170,
      location: {
        city: "Bahrdar",
        address: "33 Nile River Rd., Bahrdar",
      },
      rentalPolicies: {
        minRentalDays: 3,
        mileageUnlimited: true,
        insuranceIncluded: true,
        depositRequired: 8400,
      },
      customerReviews: [
        {
          reviewer: "Linda D.",
          rating: 4,
          comment: "Comfortable and smooth SUV.",
        },
        {
          reviewer: "James W.",
          rating: 5,
          comment: "Perfect for road trips with family.",
        },
      ],
      photos: [
    ...
    },
    {
      ...
      availability: true,
      description:
        "Smooth and comfortable sedan with modern features, great for both city and highway drives.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "27 MPG city / 36 MPG highway",
        color: "White",
      },
      horsePower: 160,
      location: {
        city: "Addis Ababa",
        address: "100 Africa Tel. Rd., Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: false,
        mileageLimitPerDay: 140,
        insuranceIncluded: true,
        depositRequired: 7200,
      },
      customerReviews: [
        {
          reviewer: "Tom H.",
          rating: 4,
          comment: "Good car, smooth ride.",
        },
        {
          reviewer: "Kathy J.",
          rating: 3,
          comment: "Average performance but comfortable interior.",
        },
      ],
      photos: [
    ...
    },
    {
      ...
      availability: true,
      description:
        "Rugged and capable 4x4 SUV perfect for off-road adventure seekers and outdoor enthusiasts.",
      features: {
        transmission: "Manual",
        fuelType: "Gasoline",
        seats: 4,
        ...
        bluetooth: false,
        "4x4Drive": true,
        fuelEfficiency: "17 MPG city / 25 MPG highway",
        color: "Green",
      },
      horsePower: 285,
      location: {
        city: "Gondar",
        address: "41 Fasil St., Gondar",
      },
      rentalPolicies: {
        minRentalDays: 3,
        mileageUnlimited: false,
      ...
      customerReviews: [
        {
          reviewer: "Steve B.",
          rating: 5,
          comment: "Perfect for off-road adventures and city driving.",
        },
        {
          reviewer: "Nina C.",
          rating: 4,
          comment: "Loved the 4x4 but manual transmission was tricky.",
        },
      ],
      photos: [
        JeepWranglerPhoto0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Luxury SUV with powerful performance and spacious interior for family and business travel.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
      ...
      location: {
        city: "Bahrdar",
        address: "12 Lake Tana Ave., Bahrdar",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: true,
      ...
      customerReviews: [
        {
          reviewer: "Amy R.",
          rating: 5,
          comment: "Luxury SUV, very comfortable.",
        },
        {
          reviewer: "Dan M.",
          rating: 4,
          comment: "Good power and spacious.",
        },
      ],
      photos: [
    ...
    },
    {
      ...
      year: 2019,
      category: "SUV",
      rentalPricePerDay: 2550,
      availability: true,
      description:
        "Dependable SUV with solid off-road capabilities and comfortable cabin for daily and weekend drives.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
      ...
      location: {
        city: "Addis Ababa",
        address: "172 Bole St., Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 1,
        mileageUnlimited: false,
        mileageLimitPerDay: 110,
        insuranceIncluded: false,
        insuranceOptions: ["Basic Coverage", "Full Coverage"],
        depositRequired: 8400,
      },
      customerReviews: [
        {
          reviewer: "Natalie Z.",
          rating: 4,
          comment: "Good all-round SUV.",
        },
        {
          reviewer: "Kyle G.",
          rating: 3,
          comment: "Adequate but could use updated features.",
        },
      ],
      photos: [
        JeepGladiatorPhoto0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Compact and efficient hatchback ideal for urban driving with modern styling and responsive handling.",
      features: {
        transmission: "Auto",
        fuelType: "Diesel",
        seats: 5,
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "29 MPG city / 39 MPG highway",
        color: "Yellow",
      },
      horsePower: 147,
      location: {
        city: "Gondar",
        address: "191 Hanock St., Gondar",
      },
      rentalPolicies: {
        minRentalDays: 1,
        mileageUnlimited: false,
      ...
      customerReviews: [
        ...
        },
        {
          reviewer: "Jason K.",
          rating: 3,
          comment: "Diesel engine was a bit noisy.",
        },
      ],
      photos: [
    ...
    },
    {
      ...
      availability: true,
      description:
        "Smooth and stylish sedan with comfortable interiors and advanced safety features.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
      ...
      customerReviews: [
        {
          reviewer: "Anna S.",
          rating: 5,
          comment: "Stylish and smooth ride.",
        },
        {
          reviewer: "Mark D.",
          rating: 4,
          comment: "Comfortable and reliable.",
        },
      ],
      photos: [
    ...
    },
    {
      ...
      availability: true,
      description:
        "Versatile SUV with spacious cabin and smooth handling, perfect for families and active lifestyles.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
        ...
        gps: true,
        bluetooth: false,
        fuelEfficiency: "22 MPG city / 29 MPG highway",
        color: "Gray",
      },
      horsePower: 184,
      location: {
        city: "Addis Ababa",
        address: "300 Ras Desta St., Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: true,
        insuranceIncluded: true,
        depositRequired: 6900,
      },
      customerReviews: [
        {
          reviewer: "Gloria P.",
          rating: 4,
          comment: "Good size and comfortable SUV.",
        },
        {
          reviewer: "Henry D.",
          rating: 3,
          comment: "Engine a bit underpowered.",
        },
      ],
      photos: [
    ...
    },
    {
      ...
      availability: true,
      description:
        "Luxury sedan with premium features and elegant design, perfect for business and special occasions.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
      ...
      location: {
        city: "Gondar",
        address: "50 Debre Tabor Rd., Gondar",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: false,
        mileageLimitPerDay: 120,
        insuranceIncluded: true,
        depositRequired: 12600,
      },
      customerReviews: [
        {
          reviewer: "Olivia W.",
          rating: 5,
          comment: "Luxury and performance combined beautifully.",
        },
        {
          reviewer: "Daniel H.",
          rating: 4,
          comment: "A bit expensive but worth it for special occasions.",
        },
      ],
      photos: [
    ...
    },
    {
      ...
      availability: true,
      description:
        "High-end luxury sedan delivering superior comfort, cutting-edge technology, and smooth driving dynamics.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
        ...
        heatedSeats: true,
        leatherInterior: true,
        fuelEfficiency: "22 MPG city / 30 MPG highway",
        color: "Black",
      },
      horsePower: 255,
      location: {
        city: "Bahrdar",
        address: "57 Tana St., Bahrdar",
      },
      rentalPolicies: {
        minRentalDays: 3,
        mileageUnlimited: false,
        mileageLimitPerDay: 120,
        insuranceIncluded: true,
        depositRequired: 14400,
      },
      customerReviews: [
        {
          reviewer: "Sophia L.",
          rating: 5,
          comment: "Exceptional luxury and comfort.",
        },
        {
          reviewer: "James B.",
          rating: 4,
    ...
    },
    {
      ...
      availability: true,
      description:
        "Compact luxury SUV with agility, elegance, and advanced infotainment for upscale urban driving.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
      ...
      location: {
        city: "Addis Ababa",
        address: "75 Rockefeller St., Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: false,
        mileageLimitPerDay: 125,
        insuranceIncluded: true,
        depositRequired: 11700,
      },
      customerReviews: [
        {
          reviewer: "Emma N.",
          rating: 5,
          comment: "Compact luxury SUV, smooth and fun to drive.",
        },
        {
          reviewer: "Michael G.",
          rating: 4,
          comment: "Stylish vehicle, good mileage for size.",
        },
      ],
      photos: [
    ...
    },
    {
      ...
      year: 2023,
      category: "Sedan",
      rentalPricePerDay: 1850,
      availability: true,
      description:
        "A premium sedan with a refined interior and advanced technology, perfect for both city drives and long journeys.",
      features: {
        transmission: "Auto",
        fuelType: "Gasoline",
        seats: 5,
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "27 MPG city / 34 MPG highway",
        color: "Black",
      },
      horsePower: 201,
      location: {
        city: "Gondar",
        address: "300 Churchill Ave, Gondar",
      },
      rentalPolicies: {
        minRentalDays: 2,
        mileageUnlimited: false,
      ...
      customerReviews: [
        {
          reviewer: "Emily R.",
          rating: 5,
          comment: "Luxurious ride, smooth handling. Loved the premium feel.",
        },
        {
          reviewer: "David K.",
          rating: 4,
          comment:
            "Great car, but could use a more intuitive infotainment system.",
        },
      ],
      photos: [
        AudiA4Photo0,
    ...
    },
    {
      ...
      availability: true,
      description:
        "A luxury compact SUV combining performance and practicality, ideal for both city and off-road adventures.",
      features: {
        transmission: "Auto",
        fuelType: "Hybrid",
        seats: 5,
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "40 MPG city / 45 MPG highway",
        color: "Silver",
      },
      horsePower: 261,
      location: {
        city: "Addis Ababa",
        address: "150 Bole Rd, Addis Ababa",
      },
      rentalPolicies: {
        minRentalDays: 3,
        mileageUnlimited: true,
      ...
      customerReviews: [
        {
          reviewer: "Michael T.",
          rating: 5,
          comment: "Spacious and smooth ride. Perfect for weekend getaways!",
        },
        {
          reviewer: "Sophia J.",
          rating: 4,
          comment: "Loved the comfort, but wish it had a panoramic sunroof.",
        },
      ],
      photos: [
        AudiQ5Photo0,
    ...
    },
    {
      ...
      features: {
        ...
        gps: true,
        bluetooth: true,
        fuelEfficiency: "14 MPG city / 22 MPG highway",
        color: "Red",
      },
      horsePower: 562,
      location: {
        city: "Bahir Dar",
        address: "10 Lake Tana Rd, Bahir Dar",
      },
      rentalPolicies: {
        minRentalDays: 4,
        mileageUnlimited: false,
      ...
      customerReviews: [
        {
          reviewer: "Chris P.",
          rating: 5,
          comment: "Insanely fast, handles like a dream! Worth every penny.",
        },
        {
          reviewer: "Linda B.",
          rating: 4,
          comment:
            "Loved driving it, but not the best for long-distance comfort.",
        },
      ],
      photos: [
        AudiR8Photo0,
